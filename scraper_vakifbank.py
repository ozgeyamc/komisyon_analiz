"""
Vakıfbank "Ürün ve Hizmet Ücretleri" sayfasını çeken scraper modülü.
"""
...
def scrape_vakifbank(url: str = VAKIFBANK_URL) -> List[UcretSatiri]:
    ...
    if not tum_satirlar:
        raise ScraperError("Vakıfbank sayfasında tablo var ama hiç veri satırı çekilemedi.")
